<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="<%= page_url('bo.clothes.ListPage') %>"><i class="fa fa-graduation-cap fa-fw"></i> Clothes</a>
            </li>
            <li>
                <a href="<%= page_url('bo.dresses.ListPage') %>"><i class="fa fa-signing fa-fw"></i> Dresses</a>
            </li>
            ...
            <com:TControl Visible="<%= user()->IsAdmin %>">
                <li>
                    <a href="<%= page_url('bo.site_infos.SiteInfosPage') %>"><i class="fa fa-th-list fa-fw"></i> Site
                        Infos</a>
                    <!-- /.nav-second-level -->
                </li>
            </com:TControl>
